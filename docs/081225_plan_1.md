...
```
NEXT_ACTION: Implement Phase 1 - VMCombobox
BLOCKED_BY: None
FILES_TO_CREATE: src/components/replication/VMCombobox.tsx
FILES_TO_MODIFY: src/components/replication/OnboardZfsTargetWizard.tsx, src/hooks/useVCenterVMs.ts
```
...
|-------|----------|--------|-------------|
| 1 | CRITICAL | ⏳ PENDING | VMCombobox - Fix 1600+ VM selector |
| 2 | CRITICAL | ⏳ PENDING | Backend Handler - `execute_onboard_zfs_target` |
| 3 | HIGH | ⏳ PENDING | Enhanced Step 1 - VM preview, duplicate warning |
| 4 | HIGH | ⏳ PENDING | Enhanced Auth - SSH key picker, test button |
| 5 | MEDIUM | ⏳ PENDING | Enhanced Config - Disk picker, ZFS options |
| 6 | MEDIUM | ⏳ PENDING | Enhanced Finish - Protection group, schedule |
