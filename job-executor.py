...
class JobExecutor(DatabaseMixin, CredentialsMixin, VCenterMixin, ScpMixin, ConnectivityMixin):
    ...
    # sync_vcenter_clusters moved to VCenterMixin
    ...
    # sync_vcenter_datastores moved to VCenterMixin
    ...
    # auto_link_vcenter moved to VCenterMixin
    ...
    # enter_vcenter_maintenance_mode moved to VCenterMixin
    # exit_vcenter_maintenance_mode moved to VCenterMixin
    # wait_for_vcenter_host_connected moved to VCenterMixin
    ...
    # get_vcenter_host moved to VCenterMixin
    # get_vcenter_settings moved to VCenterMixin
