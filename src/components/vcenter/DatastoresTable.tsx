    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-4 py-3 border-b bg-muted/50">
        ...
        <Select value={accessFilter} onValueChange={setAccessFilter}>
          <SelectTrigger className="w-[150px] h-9"><SelectValue placeholder="Accessibility" /></SelectTrigger>
          <SelectContent><SelectItem value="all">All</SelectItem><SelectItem value="accessible">Accessible</SelectItem><SelectItem value="inaccessible">Inaccessible</SelectItem></SelectContent>
        </Select>
        <Select value={capacityFilter} onValueChange={setCapacityFilter}>
          <SelectTrigger className="w-[150px] h-9"><SelectValue /></SelectTrigger>
          <SelectContent><SelectItem value="all">All Capacity</SelectItem><SelectItem value="warning">≥80% Full</SelectItem><SelectItem value="critical">≥90% Full</SelectItem></SelectContent>
        </Select>
      </div>
