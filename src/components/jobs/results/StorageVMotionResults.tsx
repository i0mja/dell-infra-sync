...
import { HardDrive, MoveRight, CheckCircle2, XCircle, Clock } from "lucide-react";

interface StorageVMotionResultsProps {
  details: any;
}

export const StorageVMotionResults = ({ details }: StorageVMotionResultsProps) => {
  if (!details) {
    return (
      <Card>
  ...
  const vmName = details.vm_name || 'Unknown VM';
