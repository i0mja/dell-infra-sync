  ...
  const JobResultsCard = ({
    ...
    switch (job.job_type) {
      ...
      case 'firmware_inventory_scan':
        return <UpdateAvailabilityScanResults details={job.details} status={job.status} />;
      default:
        ...
        try {
          ...
          <Tabs defaultValue="progress" className="w-full">
            ...
            <TabsContent value="progress" className="space-y-4 mt-4">
              ...
              {!['vcenter_sync', 'firmware_inventory_scan', 'discovery_scan'].includes(job.job_type) && <JobTasksTimeline jobId={job.id} />}
            </TabsContent>
