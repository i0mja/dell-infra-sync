...
export function DrOnboarding({ onOpenOnboardWizard }: DrOnboardingProps) {
  ...
  const steps: SetupStep[] = [
    ...
    {
      id: 'template',
      title: 'Upload ZFS Template',
      description: 'Upload a ZFS appliance OVA template for deploying replication targets',
      icon: HardDrive,
      completed: hasTemplate,
      action: () => navigate('/settings?tab=infrastructure'),
      actionLabel: hasTemplate ? 'Manage Templates' : 'Upload Template'
    },
    {
      id: 'target',
