import { FileBarChart, Download, History, Shield } from "lucide-react";
...
export const getReportsNavigation = (): ReportNavigationItem[] => [
  ...
  { name: "Update Reports", href: "/reports?category=updates", icon: Download, description: "Firmware and update reports" },
