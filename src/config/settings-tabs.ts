...
export const settingsTabs: SettingsTab[] = [
  ...
  },
  {
    ...
    description: 'Backend services, data retention, and system configuration',
    icon: Activity,
    subsections: [
      {
        id: 'overview',
        name: 'Overview',
        description: 'System health and status dashboard',
        icon: Activity,
      },
      {
        id: 'job-executor',
        name: 'Job Executor',
        description: 'Configure backend connection and authentication',
        icon: Server,
      },
      {
        id: 'retention',
        name: 'Data Retention',
        description: 'Manage logs and jobs cleanup policies',
        icon: Activity,
      },
      {
        id: 'advanced',
        name: 'Advanced',
        description: 'Network timeouts and performance tuning',
        icon: Activity,
      },
    ],
  },
