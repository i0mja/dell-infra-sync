...
import { countUniqueUpdates, countUniqueCriticalUpdates } from '@/lib/firmware-utils';
...
export function useUpdateAvailabilityScan(scanId?: string) {
  ...
  const calculateStats = useCallback(() => {
    ...
    const uniqueCriticalUpdates = countUniqueCriticalUpdates(allComponents);
